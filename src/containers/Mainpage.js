                    ...
                    <div className="my-card">
                      <Row>
                        ...
                        <Col>
                          ...
                          <br />
                          <p>
                            Robot combat, a game where participants test their
                            robot agility and durability to reach the objectives
                            while withstanding the heavy blow of their opponent.
                            Does your robot satisfy that criteria? Show us what
                    ...
                    <div className="my-card">
                      <Row>
                        ...
                        <Col>
                          ...
                          <br />
                          <p className="editted-script-2">
                            Innovating the future
                          </p>
                          <br />
                          <p>
                            Line following robot, the first step towards
                            autonomous car. A robot that follows the designated
                            path to reach its objectives. Are you capable of
                            making the fastest line follow robot? Prove your
                            skill now! Participate and claim your title as the
                            best. Challenge your knowledge in mechanical,
                    ...
                    <div className="my-card">
                      <Row>
                        ...
                        <Col>
                          ...
                          <br />
                          <p>
                            Engineering Challenge is an innovation and
                            creativity competition that is created to test the
                            ability of participants to solve engineering related
                            challenges. Test your limit as an engineer and
                            improve yourself. Think outside the box? No! Think
